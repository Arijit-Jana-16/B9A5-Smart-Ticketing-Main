...
function Count(){
    ...
    const seatCounter = document.getElementById('seat-counter').innerText = tableRows
...
function couponValidator(){
    ...
    if(couponInput.value ==='NEW15'|| couponInput.value==='Couple 20'){
        ...
        if(couponInput.value ==='NEW15'){
            ...
            document.getElementById('grand-total').innerText = totalTicketCost- (totalTicketCost*15)/100
            
        }
        else if (couponInput.value==='Couple 20') {
            const totalTicketCost =   document.getElementById('total-price').innerText
            document.getElementById('grand-total').innerText = totalTicketCost- (totalTicketCost*20)/100
        }
    }
    else if(couponInput.value !=='NEW15'|| couponInput.value!=='Couple 20'){
        document.getElementById('grand-total').innerText = document.getElementById('total-price').innerText
    }
}
